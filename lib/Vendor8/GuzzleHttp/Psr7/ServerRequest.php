...
namespace OCA\FullTextSearch_Elasticsearch\Vendor8\GuzzleHttp\Psr7;
...
use OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Message\UploadedFileInterface;
...
class ServerRequest extends Request implements ServerRequestInterface
{
    ...
    public function withUploadedFiles(array $uploadedFiles): ServerRequestInterface
    {
        ...
        if ($invalidUploadedFileFound) {
            \OCA\FullTextSearch_Elasticsearch\Vendor8\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s inside ServerRequestInterface::withUploadedFiles() is deprecated; guzzlehttp/psr7 3.0 requires an UploadedFileInterface[] tree.', \get_debug_type($invalidUploadedFile));
        }
        $new = clone $this;
    ...
    public function withParsedBody($data): ServerRequestInterface
    {
        if ($data !== null && !\is_array($data) && !\is_object($data)) {
            \OCA\FullTextSearch_Elasticsearch\Vendor8\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s to ServerRequestInterface::withParsedBody() is deprecated; guzzlehttp/psr7 3.0 requires array|object|null.', \get_debug_type($data));
        }
        $new = clone $this;
        $new->parsedBody = $data;
        return $new;
    ...
    public function getAttribute($attribute, $default = null)
    {
        if (!\is_string($attribute)) {
            \OCA\FullTextSearch_Elasticsearch\Vendor8\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s to ServerRequestInterface::getAttribute() is deprecated; guzzlehttp/psr7 3.0 requires string for $attribute.', \get_debug_type($attribute));
        }
    ...
    {
        if (!\is_string($attribute)) {
            \OCA\FullTextSearch_Elasticsearch\Vendor8\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s to ServerRequestInterface::withAttribute() is deprecated; guzzlehttp/psr7 3.0 requires string for $attribute.', \get_debug_type($attribute));
        }
        $new = clone $this;
    ...
    {
        if (!\is_string($attribute)) {
            \OCA\FullTextSearch_Elasticsearch\Vendor8\trigger_deprecation('guzzlehttp/psr7', '2.11', 'Passing %s to ServerRequestInterface::withoutAttribute() is deprecated; guzzlehttp/psr7 3.0 requires string for $attribute.', \get_debug_type($attribute));
        }
        if (\false === array_key_exists($attribute, $this->attributes)) {
            return $this;
        }
