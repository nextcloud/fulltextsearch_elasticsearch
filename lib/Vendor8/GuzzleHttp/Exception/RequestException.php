...
use OCA\FullTextSearch_Elasticsearch\Vendor8\GuzzleHttp\BodySummarizer;
use OCA\FullTextSearch_Elasticsearch\Vendor8\GuzzleHttp\BodySummarizerInterface;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    {
        \OCA\FullTextSearch_Elasticsearch\Vendor8\trigger_deprecation('guzzlehttp/guzzle', '7.11', '%s::wrapException() is deprecated and will be removed in 8.0. Create a %s directly instead.', self::class, self::class);
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null): self
    {
        ...
        $uri = \OCA\FullTextSearch_Elasticsearch\Vendor8\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
