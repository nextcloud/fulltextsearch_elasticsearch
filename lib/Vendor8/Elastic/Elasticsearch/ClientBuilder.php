...
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Exception\AuthenticationException;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Exception\ConfigException;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Exception\HttpClientException;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Exception\InvalidArgumentException;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Transport\Adapter\AdapterInterface;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Transport\Adapter\AdapterOptions;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Transport\RequestOptions;
...
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\TransportBuilder;
use OCA\FullTextSearch_Elasticsearch\Vendor8\GuzzleHttp\Client as GuzzleHttpClient;
...
class ClientBuilder
{
    ...
    {
        if (\false !== strpos(get_class($transport->getClient()), 'OCA\FullTextSearch_Elasticsearch\Vendor8\Symfony\Component\HttpClient')) {
            return \true;
        }
        try {
            if (\false !== strpos(get_class($transport->getAsyncClient()), 'OCA\FullTextSearch_Elasticsearch\Vendor8\Symfony\Component\HttpClient')) {
                return \true;
            }
