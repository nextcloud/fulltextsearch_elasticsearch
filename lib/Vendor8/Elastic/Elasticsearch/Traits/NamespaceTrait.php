...
namespace OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Traits;

use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\AsyncSearch;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Autoscaling;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Cat;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Ccr;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Cluster;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Connector;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\DanglingIndices;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Enrich;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Eql;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Esql;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Features;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Fleet;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Graph;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Ilm;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Indices;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Inference;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Ingest;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\License;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Logstash;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Migration;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Ml;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Monitoring;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Nodes;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Profiling;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\QueryRules;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Rollup;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\SearchApplication;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\SearchableSnapshots;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Security;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Shutdown;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Simulate;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Slm;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Snapshot;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Sql;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Ssl;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Streams;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Synonyms;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Tasks;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\TextStructure;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Transform;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Watcher;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Elasticsearch\Endpoints\Xpack;
/**
