...
namespace OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport;

use Composer\InstalledVersions;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\Async\OnFailureDefault;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\Async\OnFailureInterface;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\Async\OnSuccessDefault;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\Async\OnSuccessInterface;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\NodePool\Node;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\NodePool\NodePoolInterface;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\Exception\InvalidArgumentException;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Elastic\Transport\Exception\NoAsyncClientException;
...
use OCA\FullTextSearch_Elasticsearch\Vendor8\Http\Discovery\HttpAsyncClientDiscovery;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Http\Promise\Promise;
use OCA\FullTextSearch_Elasticsearch\Vendor8\OpenTelemetry\API\Globals;
use OCA\FullTextSearch_Elasticsearch\Vendor8\OpenTelemetry\API\Trace\TracerInterface;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Client\ClientExceptionInterface;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Client\ClientInterface;
use OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Client\NetworkExceptionInterface;
...
use OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Message\ServerRequestInterface;
...
final class Transport implements ClientInterface, HttpAsyncClient
{
    ...
    private function getClientLibraryInfo(): array
    {
        ...
        if (\false !== strpos($clientClass, 'OCA\FullTextSearch_Elasticsearch\Vendor8\GuzzleHttp\Client')) {
            return ['gu', InstalledVersions::getPrettyVersion('guzzlehttp/guzzle')];
        }
        if (\false !== strpos($clientClass, 'OCA\FullTextSearch_Elasticsearch\Vendor8\Symfony\Component\HttpClient')) {
