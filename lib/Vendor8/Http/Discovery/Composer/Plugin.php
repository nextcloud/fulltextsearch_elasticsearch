...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['OCA\FullTextSearch_Elasticsearch\Vendor8\Http\Client\HttpAsyncClient'], 'php-http/client-implementation' => ['OCA\FullTextSearch_Elasticsearch\Vendor8\Http\Client\HttpClient'], 'psr/http-client-implementation' => ['OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Client\ClientInterface'], 'psr/http-factory-implementation' => ['OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Message\RequestFactoryInterface', 'OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Message\ResponseFactoryInterface', 'OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Message\ServerRequestFactoryInterface', 'OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Message\StreamFactoryInterface', 'OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Message\UploadedFileFactoryInterface', 'OCA\FullTextSearch_Elasticsearch\Vendor8\Psr\Http\Message\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions): array
    {
        ...
        if (ClassDiscovery::safeClassExists(\OCA\FullTextSearch_Elasticsearch\Vendor8\Phalcon\Http\Message\RequestFactory::class, \false)) {
