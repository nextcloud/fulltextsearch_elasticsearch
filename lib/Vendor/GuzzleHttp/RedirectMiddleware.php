...
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Exception\BadResponseException;
...
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Exception\TooManyRedirectsException;
...
class RedirectMiddleware
{
    ...
    ): PromiseInterface
    {
        ...
        return $fn($request, $options)->then(function (
            #[\SensitiveParameter]
    ...
    {
        return $promise->then(static function (
            #[\SensitiveParameter]
            ResponseInterface $response
