...
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Exception\ConnectTimeoutException;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Exception\InvalidArgumentException;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Exception\NetworkException;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Exception\NetworkTimeoutException;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Exception\RequestException;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Exception\ResponseException;
...
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Psr7\FnStream;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Psr7\HttpFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Psr7\LazyOpenStream;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\RequestOptions;
...
final class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function isCurlShareHandle($value): bool
    {
        ...
        return \class_exists('OCA\FullTextSearch_Elasticsearch\Vendor\CurlSharePersistentHandle') && $value instanceof \OCA\FullTextSearch_Elasticsearch\Vendor\CurlSharePersistentHandle;
    }
    ...
    ): array
    {
        ...
        if (\in_array($multiplex, [Multiplexing::WAIT, Multiplexing::REQUIRE_WAIT], \true) && CurlVersion::supportsMultiplex() && ($resolvedVersion === \CURL_HTTP_VERSION_2_0 || \defined('CURL_HTTP_VERSION_2_PRIOR_KNOWLEDGE') && $resolvedVersion === (int) \constant('CURL_HTTP_VERSION_2_PRIOR_KNOWLEDGE') || \defined('CURL_HTTP_VERSION_3') && $resolvedVersion === (int) \constant('CURL_HTTP_VERSION_3') || \defined('CURL_HTTP_VERSION_3ONLY') && $resolvedVersion === (int) \constant('CURL_HTTP_VERSION_3ONLY'))) {
    ...
    {
        $option = \defined('CURLOPT_INFILESIZE_LARGE') ? (int) \constant('CURLOPT_INFILESIZE_LARGE') : \CURLOPT_INFILESIZE;
