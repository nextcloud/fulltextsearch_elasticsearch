...
class StreamHandler
{
    ...
    private function createStream(RequestInterface $request, array $options)
    {
        ...
        return $this->createResource(function () use($uri, $contextResource, $context, $options, $request) {
            ...
            if (\function_exists('OCA\\FullTextSearch_Elasticsearch\\Vendor\\http_get_last_response_headers')) {
                /** @var array|null */
                $http_response_header = \OCA\FullTextSearch_Elasticsearch\Vendor\http_get_last_response_headers();
            }
