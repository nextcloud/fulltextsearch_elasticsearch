...
final class CurlVersion
{
    ...
    {
        $version = self::get();
        return \defined('CURLOPT_PROTOCOLS_STR') && null !== $version && version_compare($version, self::PROTOCOLS_STR_VERSION, '>=');
    }
    ...
    private static function getVersionInfo(): ?array
    {
        if (null === self::$versionInfo) {
            if (!\function_exists('curl_version') && !\function_exists('OCA\FullTextSearch_Elasticsearch\Vendor\curl_version')) {
