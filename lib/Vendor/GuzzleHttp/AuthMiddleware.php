...
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Auth\DigestAuth;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Auth\DigestChallenge;
...
final class AuthMiddleware
{
    ...
    ): PromiseInterface
    {
        ...
        if ($preemptive !== null) {
            ...
            return ($this->nextHandler)($preemptive, $preemptiveOptions)->then(function (
                #[\SensitiveParameter]
        ...
        return ($this->nextHandler)($probeRequest, $probeOptions)->then(function (
            #[\SensitiveParameter]
            ResponseInterface $response
    ...
    )
    {
        ...
        return ($this->nextHandler)($retryRequest, $downstreamOptions)->then(function (
            #[\SensitiveParameter]
