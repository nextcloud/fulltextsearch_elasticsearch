...
class Connector extends AbstractEndpoint
{
     ...
     *     hard?: bool, // A flag indicating if the connector should be hard deleted.
     ...
     *     include_deleted?: bool, // A flag to indicate if the desired connector should be fetched, even if it was soft-deleted.
     *     pretty?: bool, // Pretty format the returned JSON response. (DEFAULT: false)
     *     human?: bool, // Return human readable values for statistics. (DEFAULT: true)
     *     error_trace?: bool, // Include the stack trace of returned errors. (DEFAULT: false)
     *     source?: string, // The URL-encoded request definition. Useful for libraries that do not accept a request body for non-POST requests.
