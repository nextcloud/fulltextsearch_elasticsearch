...
namespace OCA\FullTextSearch_Elasticsearch\Vendor\Elastic\Elasticsearch\Helper\Esql;
...
abstract class EsqlBase
{
     ...
     * Used by several ES|QL commands.
     */
    protected function formatKeyValues(array $map, string $joinText = "=", string $implodeText = ", ", bool $jsonEncode = \false): string
    {
        return implode($implodeText, array_map(function (string $key, mixed $value) use ($joinText) {
            return $key . " " . $joinText . " " . $value;
        }, array_keys($map), array_map($jsonEncode ? array($this, 'esql_json_encode') : array($this, 'formatId'), $map)));
    }
    /**
     ...
     */
    abstract protected function renderInternal(): string;
     ...
     *         ->sort("emp_no");
     */
    public function fork(EsqlBase $fork1, ?EsqlBase $fork2 = null, ?EsqlBase $fork3 = null, ?EsqlBase $fork4 = null, ?EsqlBase $fork5 = null, ?EsqlBase $fork6 = null, ?EsqlBase $fork7 = null, ?EsqlBase $fork8 = null): ForkCommand
    {
        if ($this->isForked()) {
