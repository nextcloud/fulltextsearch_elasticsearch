...
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Client as GuzzleHttp;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Promise\Promise;
use OCA\FullTextSearch_Elasticsearch\Vendor\GuzzleHttp\Psr7\Request as GuzzleRequest;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Adapter\Artax\Client as Artax;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Adapter\Buzz\Client as Buzz;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Adapter\Cake\Client as Cake;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Adapter\Guzzle5\Client as Guzzle5;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Adapter\Guzzle6\Client as Guzzle6;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Adapter\Guzzle7\Client as Guzzle7;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Adapter\React\Client as React;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Client\Curl\Client as Curl;
...
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Client\Socket\Client as Socket;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Discovery\ClassDiscovery;
...
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\MessageFactory\DiactorosMessageFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\MessageFactory\GuzzleMessageFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\MessageFactory\SlimMessageFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\StreamFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\StreamFactory\DiactorosStreamFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\StreamFactory\GuzzleStreamFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\StreamFactory\SlimStreamFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\UriFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\UriFactory\DiactorosUriFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\UriFactory\GuzzleUriFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Http\Message\UriFactory\SlimUriFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Laminas\Diactoros\Request as DiactorosRequest;
use OCA\FullTextSearch_Elasticsearch\Vendor\Nyholm\Psr7\Factory\HttplugFactory as NyholmHttplugFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Psr\Http\Client\ClientInterface as Psr18Client;
use OCA\FullTextSearch_Elasticsearch\Vendor\Psr\Http\Message\RequestFactoryInterface as Psr17RequestFactory;
use OCA\FullTextSearch_Elasticsearch\Vendor\Slim\Http\Request as SlimRequest;
use OCA\FullTextSearch_Elasticsearch\Vendor\Symfony\Component\HttpClient\HttplugClient as SymfonyHttplug;
use OCA\FullTextSearch_Elasticsearch\Vendor\Symfony\Component\HttpClient\Psr18Client as SymfonyPsr18;
/**
 * @internal
 *
...
final class CommonClassesStrategy implements DiscoveryStrategy
{
    ...
    {
        return new \OCA\FullTextSearch_Elasticsearch\Vendor\Buzz\Client\FileGetContents(Psr17FactoryDiscovery::findResponseFactory());
    }
